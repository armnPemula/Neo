    ...
    def _create_default_profiles(self):
        try:
            ...
            if existing_profiles:
                ...
                if default_exists:
                    logger.info(f"Found existing default profile")
                    self._update_profiles_to_hybrid()
                    return
    
            logger.info("No default profile found, creating hybrid profile...")
    ...
    def _update_profiles_to_hybrid(self):
        try:
            ...
            if not existing_profiles:
                logger.warning("No profiles found. Creating hybrid default profile...")
                self._create_default_profiles()
                return
            ...
            if not default_profile:
                logger.warning("Default profile not found. Creating hybrid default profile...")
                self._create_default_profiles()
                return
